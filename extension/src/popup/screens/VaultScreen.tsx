                                ...
                                {search ? (
                                    ...
                                    <>
                                        ...
                                        <div style={{ textAlign: "center" }}>
                                            ...
                                            >
                                                Add your first password or
                                                migrate from your browser
                                            </div>
                                        </div>
                                        <div
            ...
            <div style={{ marginBottom: 20 }}>
                ...
                >
                    ...
                    <div style={{ fontSize: 11 }}>
                        Your vault is encrypted with AES-256-GCM using a key
                        derived from your master password via PBKDF2 (600,000
                        iterations). The server never receives your master
                        password or plaintext data.
                    </div>
                </div>
            </div>
